        ...
        return withContext(Dispatchers.IO)
        {
            ...
            arrayListOf(
                Animal(
                    "Ballena",
                    R.drawable.ballena,
                    "Estos mamíferos tienen un largo cráneo de hasta un tercio de la longitud total de su cuerpo, que en edad adulta mide de 15 a 17 metros y pesa de 50 a 80 toneladas.1\u200B Poseen un estrecho y arqueado maxilar, lo que da a estos animales un perfil convexo."
                ),
                Animal(
                    "Bisonte",
                    R.drawable.bisonte,
                ...
                Animal(
                    "Jirafa",
                    R.drawable.jirafa,
                    "Es un animal apacible y sociable que vive en pequeños rebaños conducidos por un macho adulto que lidera un grupo de hembras con sus crías y otros machos que aún no han alcanzado la madurez sexual.\n" +
                            "\n" +
                ...
                Animal(
                    "Mono",
                    R.drawable.mono,
                    "Es el único simio salvaje de Europa que vive en libertad, concretamente en el peñón de gibraltar.\n" +
                            "\n" +
                ...
                Animal(
                    "Ciervo",
                    R.drawable.venado,
                    "Cérvido de gran tamaño, pudiendo los machos pesar hasta los 200 kg. Las hembras en esta especie son de menor tamaño.\n" +
                            "\n" +
                ...
                Animal(
                    "Zorro",
                    R.drawable.zorro,
                    "El zorro es el mamífero carnívoro más abundante del planeta. Alcanza casi el metro de longitud, destacando en su figura la cola de unos 35 cms. de larga. La cabeza la tiene ancha, el hocico puntiagudo y las orejas son grandes y puntiagudas.\n" +
                            "\n" +
